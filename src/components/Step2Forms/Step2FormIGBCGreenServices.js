...
const Step2FormIGBCGreenServices = ({ formData, handleChange, handlePrevious, handleTermsChange, handlePaymentScheduleChange }) => {
    ...
    return (
        <div className="form-step">
            <h2>Step 2: IGBC Green Services Building Certification</h2>
            ...
            <div className="form-group" style={{ width: '100%', maxWidth: '100%' }}>
                <ProjectOverviewGenerator
                    ...
                    serviceType="igbc-green-services-building"
                />
            </div>
...
export default Step2FormIGBCGreenServices;
