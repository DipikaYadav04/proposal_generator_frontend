...
const Step2FormIGBCExisting = ({ formData, handleChange, handlePrevious, handleTermsChange, handlePaymentScheduleChange }) => {
    ...
    // Handle cost input with comma formatting (for individual fee fields)
    ...
    const totalFees = registrationFee + certificationFee;

    return (
        <div className="form-step">
            <h2>Step 2: IGBC Existing Building Certification</h2>
            <p className="template-badge" style={{ background: 'linear-gradient(135deg, #27AE60 0%, #1E8449 100%)' }}>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ 
                            ...
                            {formData.currency || 'INR'} {formatCostWithCommas(totalFees)}
                        </div>
                    </div>
                </div>
            ...
            {/* Total Consultancy Cost - Hidden field for backend */}
            <input 
                type="hidden" 
                name="cost" 
                value={formatCostWithCommas(totalFees)} 
            />
            ...
            <div className="form-group" style={{ width: '100%', maxWidth: '100%' }}>
                <TermsAndConditions 
                    ...
                    serviceType="igbc-existing-building"
                />
            </div>
...
export default Step2FormIGBCExisting;
