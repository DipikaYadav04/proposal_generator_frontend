...
const OVERVIEW_TEMPLATES = {
    ...
    'igbc-net-zero': [
        (p, c, a) => `The ${p} is located in ${c}, with a total built-up area of ${a} sq. ft. The project aims to achieve IGBC Net Zero certification, targeting net-zero energy consumption through a combination of ultra-efficient building design, on-site renewable energy generation, and innovative energy management strategies.`,
        (p, c, a) => `${p}, situated in ${c}, spans ${a} sq. ft. The project seeks IGBC Net Zero certification to demonstrate that buildings can operate with minimal environmental impact by achieving net-zero energy through passive design, high-performance systems, and renewable energy integration.`,
        (p, c, a) => `Located in ${c}, ${p} covers ${a} sq. ft. Pursuing IGBC Net Zero certification, this project will showcase cutting-edge sustainability by achieving net-zero energy performance through aggressive demand reduction, energy-efficient technologies, and on-site renewable energy production.`,
    ],
    'ecbc-a': [
